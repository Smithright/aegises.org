...
window.addEventListener('beforeprint',()=>{printOpen=Array.from(document.querySelectorAll<HTMLDetailsElement>('main details:not([open]):not(.origin)'));printOpen.forEach(el=>el.open=true);});
