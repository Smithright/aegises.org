# AGI Reactor · Draft 2.5.1 · 14 September 2026
...
Thesis: the host’s coordination and governance functions can be expressed through policy-governed, stateful service contracts. A necessary host function that cannot be expressed or enforced under those contracts would refute that claim. It is a hypothesis about the host, not a claim that orchestration alone produces general intelligence or alignment.
...
Reactor is a proposed containment and orchestration kernel for cognitive architectures.
...
Cognitive architecturesReason · plan · propose
...
Smithright, Ryan. AGI Reactor: A Governable Reference Architecture for Enterprise AGI. AEGISES, draft 2.5.1, 14 September 2026. Version permalink · BibTeX · CSL-JSON.
...
These are bounded recursive self-improvement (RSI) loops over software: the system proposes work on parts of its own implementation. It is not evidence of an open-ended increase in general intelligence. Proposed work still requires admission, an owner, a budget, independent evaluation and authorized release. Workers may improve a skill; they may not widen their own grants or waive the gate.
...
## A substrate for cognitive architectures.

This is not a solved safe AGI architecture. It is a scalable, governable substrate that can implement and orchestrate cognitive architectures.
...
The world could use an open-source reference architecture around which to debate and cooperate on an implementable, governable host for orchestrated AGI cognitive architectures. This is our contribution: an orchestration architecture reduced to a small set of primitives, offered for review, consideration and use.
...
AGI Reactor · Draft 2.5.1 · 14 September 2026Previous edition ↗Back to the beginning ↑
